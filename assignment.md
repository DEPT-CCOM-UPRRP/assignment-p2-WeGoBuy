...
Before starting this programming assignment, we highly recommend completing the following tutorials: [Tutorial 5: Multiple views and advanced interactiivity](https://github.com/rmegret/447-materials/tree/main/tutorials/5_D3_Tutorial_MV_Advanced_Interactivity), and [Tutorial 7: Advanced concepts](https://github.com/rmegret/447-materials/tree/main/tutorials/7_D3_Tutorial_Advanced_Concepts). If you are having trouble with your assignment, referencing the tutorials first is often the best place to start!
...
**This video shows the required interaction [p2-demo.mp4](https://drive.google.com/file/d/1OR0xAfutS-9H4REsybdBqNeoENcQtAzY/view?usp=drive_link), also in original repository: [p2-demo.mp4](https://github.com/UBC-InfoVis/436V-materials/blob/23Sep/programming-assignments/skeletons/p2/p2-demo.mp4)**
